    ...
    return '<header class="' + headerClass + '">' +
      '<div class="container header-inner">' +
        ...
        '<nav class="site-nav" aria-label="主要ナビゲーション">' +
          ...
          '<a href="' + base + 'solutions/index.html"' + (currentPage.includes('/solutions') || currentPage.includes('/cases') ? ' aria-current="page"' : '') + '>ソリューション・導入事例</a>' +
      ...
      '<div class="container footer-grid">' +
        ...
        '<div>' +
          ...
          '<div class="footer-links">' +
            '<a href="' + base + 'solutions/index.html">ソリューション・導入事例</a>' +
